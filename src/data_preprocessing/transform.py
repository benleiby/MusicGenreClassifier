...
# For each image, apply the tensor transformation and move to corresponding input directory.
# While applying transformations, also calculate the mean and std deviation for normalization.
